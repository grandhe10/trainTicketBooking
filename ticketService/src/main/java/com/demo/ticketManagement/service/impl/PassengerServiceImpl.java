...
public class PassengerServiceImpl implements PassengerService {
	...
	private String addPassengers1(PassengerRequestDto passengerRequestDto, Long ticketId) {
		...
		return restTemplate
				.exchange("http://TRAINSERVICE/seats/" + trainScheduleId, HttpMethod.PUT, entity, String.class)
				.getBody();
	}
	...
	public ItenaryResponseDto getItenary(Long ticketId) {
		...
		String url1 = "http://TRAINSERVICE/trainSchedules/" + trainScheduleId;
		 ...
		 */
		String url2 = "http://TRAINSERVICE/trains/" + trainId;
